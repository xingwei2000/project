...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="${pageContext.request.contextPath}/resources/images/face.jpg" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName"><shiro:principal property="realname"/></cite></a>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            ...
            <p>你好！<span class="userName"><shiro:principal property="realname"/></span>, 欢迎登录</p>
        </div>
        <!-- 搜索 -->
        ...
        <div class="layui-tab mag0" lay-filter="bodyTab" id="top_tabs_box">
            ...
            <div class="layui-tab-content clildFrame">
                <div class="layui-tab-item layui-show">
                    <iframe src="http://www.nows.fun"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="layui-footer footer">
        <p><span>copyright @2018 <shiro:principal property="realname"/></span>　　<a onclick="donation()" class="layui-btn layui-btn-danger layui-btn-sm">捐赠作者</a></p>
    </div>
</div>
...
<script>
    layui.use(['jquery'],function () {
        ...
        $("#logout").click(function () {
            $.get("/sysUser/logout.do",function (rs) {
                if (rs.code == 200){
                    // 退出成功 ，跳转到登录页面 使用parent.window的意思是 main.jsp使用的是iframe
                    layer.confirm('确定退出吗?', function(index){
                        layer.close(index);
                        parent.window.location.href = cxt+"/index.jsp" ;
                    });
                }
            })
        });
